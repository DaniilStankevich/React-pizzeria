...
export const CartItem: React.FC<CartItemProps> = ({ id, name, type, count, price, size,  imageUrl, uniqueValue}) => {

const dispatch = useDispatch()


const onClickPlus = () => {
  dispatch( addItem({id, type, size,name, count, price, imageUrl, uniqueValue  }))  
}

const onClickMinus = () => {
  dispatch( minusItem ({id, type, size}))
  console.log('Сработка минус')
}


const onClickRemove = () => {
  dispatch( removeItem(uniqueValue))
}
